...
module Trojan_Trigger(rst, state, Tj_Trig);
  ...
  assign _042_[3:0] = { state[29:28], state[25:24] };
  assign _046_[5] = rst;
  assign _045_[3:0] = { state[95], state[93:91] };
  assign _044_[3:0] = { state[119:117], state[115] };
  assign _043_[3:0] = { state[62:60], state[58] };
endmodule
